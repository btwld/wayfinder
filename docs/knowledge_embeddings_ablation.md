...
The [checked-in results](../packages/knowledge_embeddings/fixtures/benchmarks/okf_ablation_results.json)
...
cache behavior remain in the [local-search report](knowledge_embeddings_local_search.md).

## Reproduce

From `packages/knowledge_embeddings`:
