...
component comparisons are in the [ablation report](wayfinder_embeddings_ablation.md).
...
[local search report](wayfinder_embeddings_local_search.md).

## New diagnostic cases

The [fixture](../packages/wayfinder_embeddings/fixtures/knowledge_retrieval/cases.json)
...
Run from `packages/wayfinder_embeddings`:
