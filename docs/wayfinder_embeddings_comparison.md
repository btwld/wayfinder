...
The [agreed plan](wayfinder_embeddings_benchmark_plan.md) defined the comparison.
The subsequent [small-model comparison](wayfinder_embeddings_model_comparison.md)
...
From `packages/wayfinder_embeddings`, with the model prepared and ObjectBox
...
The [fixture manifest](../packages/wayfinder_embeddings/fixtures/embedding_comparison/manifest.json)
records hashes and selection. The compact checked-in
[results](../packages/wayfinder_embeddings/fixtures/benchmarks/embedding_comparison_results.json)
