...
Status: executed 2026-09-09; see the [measured report](knowledge_embeddings_comparison.md). This plan does not change retrieval
defaults or OKF/profile semantics. Existing measurements are in the
[component report](knowledge_embeddings_ablation.md).
