...
published at 0.1.0. The CLI and embeddings library have a prepared 0.1.1 patch
release; see [release status and upgrade notes](docs/releasing.md#prepared-release-011).
