...
[OKF-0.2.md](okf-profile/OKF-0.2.md) is that text: the spec verbatim (body verified
...
`okf-profile/SKILL.md` had carried "stable paths are immutable"; `SEEDING.md` had told
...
version format became `<year>.<serial>`. Five skills changed: `okf-profile`,
