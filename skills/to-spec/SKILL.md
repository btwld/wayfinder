...
1. Explore the repo to understand the current state of the codebase, if you haven't already. Read the knowledge bundle before writing: start at `knowledge/index.md`, open the area covering the subject you're specifying, and read it through — its Glossary Definitions supply the vocabulary for the spec, and its Business Rules, Decisions, and Questions are the constraints. Add `knowledge/architecture/` for system-wide structure and ADRs.
